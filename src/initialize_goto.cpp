...
void translator::add_initial_symbols() {
  ...
  code_typet ct = code_typet(code_typet::parameterst(), void_type());
  ...
  cprover_deallocated.type =
      pointer_typet(void_type(), config.ansi_c.pointer_width);
