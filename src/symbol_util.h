...
class ll2gb::translator::symbol_util {
  static std::set<std::string>
      typedef_tag_set; ///< Stores names of typdefs whose type symbols have
                       ///< already been added.
  static std::set<const llvm::Type *>
      current_struct_eval; ///< Used to evaluate the type of recursive structs.
  static unsigned var_counter; ///< A static var_counter used when debug names
                               ///< are not present.
