...
void set_function_symbol_value(goto_functionst::function_mapt &function_map,
...
void add_function_definitions(std::string name, goto_functionst &goto_functions,
                              symbol_tablet &symbol_table) {
  goto_programt gp;
...
void set_entry_point(goto_functionst &goto_functions,
  ...
  // bmct bmc;
  ansi_c_entry_point(symbol_table, parse_options.get_message_handler(),
                     object_factory_params);
  goto_functions.function_map.insert(
      std::pair<const dstringt, goto_functionst::goto_functiont>(
          "__CPROVER__start", goto_functionst::goto_functiont()));
