...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp3, label %land.lhs.true, label %land.end8, !dbg !44

land.lhs.true:                                    ; preds = %for.end
  %6 = load i32, i32* %y, align 4, !dbg !45
  %cmp4 = icmp eq i32 %6, 1000, !dbg !47
  br i1 %cmp4, label %land.rhs, label %land.end8, !dbg !48

land.rhs:                                         ; preds = %land.lhs.true
  %7 = load i32, i32* %x, align 4, !dbg !49
  %cmp5 = icmp eq i32 %7, 0, !dbg !51
  br i1 %cmp5, label %land.rhs6, label %land.end, !dbg !52

land.rhs6:                                        ; preds = %land.rhs
  %8 = load i32, i32* %z, align 4, !dbg !53
  %cmp7 = icmp eq i32 %8, 1000, !dbg !55
  br label %land.end

land.end:                                         ; preds = %land.rhs6, %land.rhs
  %9 = phi i1 [ false, %land.rhs ], [ %cmp7, %land.rhs6 ]
  br label %land.end8

land.end8:                                        ; preds = %land.end, %land.lhs.true, %for.end
  %10 = phi i1 [ false, %land.lhs.true ], [ false, %for.end ], [ %9, %land.end ]
  %land.ext = zext i1 %10 to i32, !dbg !56
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %land.ext), !dbg !58
  %11 = load i32, i32* %retval, align 4, !dbg !59
  ret i32 %11, !dbg !59
}
...
!1 = !DIFile(filename: "for-loop_fail/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
...
!58 = !DILocation(line: 13, column: 3, scope: !57)
!59 = !DILocation(line: 14, column: 1, scope: !6)
