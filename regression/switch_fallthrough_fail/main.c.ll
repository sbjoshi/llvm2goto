; ModuleID = 'switch_fallthrough_fail/main.c'
source_filename = "switch_fallthrough_fail/main.c"
...
entry:
  ...
  %call1 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 1), !dbg !11
  %call2 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 1), !dbg !12
  %call3 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 0), !dbg !13
  ret i32 0, !dbg !14
}
...
!1 = !DIFile(filename: "switch_fallthrough_fail/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
...
!14 = !DILocation(line: 11, column: 2, scope: !6)
