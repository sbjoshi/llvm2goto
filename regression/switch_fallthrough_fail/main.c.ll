...
entry:
  ...
  %call3 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 0), !dbg !14
  ret i32 0, !dbg !15
}
...
!1 = !DIFile(filename: "switch_fallthrough_fail/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
...
!12 = !DILocation(line: 6, column: 13, scope: !7)
!13 = !DILocation(line: 7, column: 13, scope: !7)
!14 = !DILocation(line: 8, column: 14, scope: !7)
!15 = !DILocation(line: 11, column: 2, scope: !7)
