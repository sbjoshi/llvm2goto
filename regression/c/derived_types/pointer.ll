...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32** %ptr, metadata !14, metadata !12), !dbg !16
  store i32* %i, i32** %ptr, align 8, !dbg !17
  %0 = load i32*, i32** %ptr, align 8, !dbg !18
  store i32 10, i32* %0, align 4, !dbg !19
  %1 = load i32, i32* %i, align 4, !dbg !20
  %cmp = icmp eq i32 %1, 10, !dbg !21
...
!1 = !DIFile(filename: "pointer.c", directory: "/home/ubuntu/llvm2goto/regression/c/derived_types")
!2 = !{}
...
!14 = !DILocalVariable(name: "ptr", scope: !7, file: !1, line: 3, type: !15)
