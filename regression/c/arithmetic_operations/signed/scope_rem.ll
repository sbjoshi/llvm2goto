; ModuleID = 'scope_rem.c'
source_filename = "scope_rem.c"
...
entry:
  ...
  %rem = srem i32 %0, %1, !dbg !19
  store i32 %rem, i32* %c, align 4, !dbg !16
  %2 = load i32, i32* %c, align 4, !dbg !20
  %cmp = icmp eq i32 %2, -1, !dbg !21
  ...
  %rem4 = srem i32 %3, %4, !dbg !32
  store i32 %rem4, i32* %c3, align 4, !dbg !29
  %5 = load i32, i32* %c3, align 4, !dbg !33
  %cmp5 = icmp eq i32 %5, -2, !dbg !34
...
!1 = !DIFile(filename: "scope_rem.c", directory: "/home/rasika/llvm2goto/regression/c/arithmetic_operations/signed")
!2 = !{}
