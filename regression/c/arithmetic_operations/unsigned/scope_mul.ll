; ModuleID = 'scope_mul.c'
source_filename = "scope_mul.c"
...
entry:
  ...
  store i32 %mul, i32* %c, align 4, !dbg !16
  %2 = load i32, i32* %c, align 4, !dbg !20
  %cmp = icmp eq i32 %2, 10, !dbg !21
  ...
  store i32 3, i32* %a1, align 4, !dbg !25
  ...
  %3 = load i32, i32* %a1, align 4, !dbg !30
  %4 = load i32, i32* %b2, align 4, !dbg !31
  %mul4 = mul nsw i32 %3, %4, !dbg !32
  store i32 %mul4, i32* %c3, align 4, !dbg !29
  %5 = load i32, i32* %c3, align 4, !dbg !33
  %cmp5 = icmp eq i32 %5, 15, !dbg !34
...
!1 = !DIFile(filename: "scope_mul.c", directory: "/home/rasika/llvm2goto/regression/c/arithmetic_operations/unsigned")
!2 = !{}
...
!27 = !DILocation(line: 6, column: 14, scope: !24)
