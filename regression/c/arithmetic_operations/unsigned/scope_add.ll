; ModuleID = 'scope_add.c'
source_filename = "scope_add.c"
...
entry:
  ...
  %add4 = add nsw i32 %3, %4, !dbg !32
  store i32 %add4, i32* %c3, align 4, !dbg !29
  %5 = load i32, i32* %c3, align 4, !dbg !33
  %cmp5 = icmp eq i32 %5, 10, !dbg !34
...
!1 = !DIFile(filename: "scope_add.c", directory: "/home/rasika/llvm2goto/regression/c/arithmetic_operations/unsigned")
!2 = !{}
