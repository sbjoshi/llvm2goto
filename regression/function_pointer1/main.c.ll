...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @f2(i32 %x, i32 %y) #0 !dbg !20 {
entry:
...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %res, metadata !33, metadata !DIExpression()), !dbg !34
  call void @llvm.dbg.declare(metadata i32 (i32, i32)** %pf, metadata !35, metadata !DIExpression()), !dbg !38
...
!1 = !DIFile(filename: "function_pointer1/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
...
!7 = distinct !DISubprogram(name: "f1", scope: !1, file: !1, line: 7, type: !8, isLocal: false, isDefinition: true, scopeLine: 8, flags: DIFlagPrototyped, isOptimized: false, unit: !0, retainedNodes: !2)
...
!15 = !DILocation(line: 9, column: 10, scope: !7)
!16 = !DILocation(line: 9, column: 12, scope: !7)
!17 = !DILocation(line: 9, column: 11, scope: !7)
!18 = !DILocation(line: 9, column: 13, scope: !7)
!19 = !DILocation(line: 9, column: 3, scope: !7)
!20 = distinct !DISubprogram(name: "f2", scope: !1, file: !1, line: 12, type: !8, isLocal: false, isDefinition: true, scopeLine: 13, flags: DIFlagPrototyped, isOptimized: false, unit: !0, retainedNodes: !2)
!21 = !DILocalVariable(name: "x", arg: 1, scope: !20, file: !1, line: 12, type: !10)
!22 = !DILocation(line: 12, column: 12, scope: !20)
!23 = !DILocalVariable(name: "y", arg: 2, scope: !20, file: !1, line: 12, type: !10)
...
!30 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 17, type: !31, isLocal: false, isDefinition: true, scopeLine: 18, isOptimized: false, unit: !0, retainedNodes: !2)
!31 = !DISubroutineType(types: !32)
!32 = !{!10}
!33 = !DILocalVariable(name: "res", scope: !30, file: !1, line: 19, type: !10)
