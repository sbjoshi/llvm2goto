...
entry:
  ...
  call void @f(), !dbg !15
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 0), !dbg !16
  ret i32 0, !dbg !17
}
...
!11 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 4, type: !12, isLocal: false, isDefinition: true, scopeLine: 5, isOptimized: false, unit: !0, retainedNodes: !2)
!12 = !DISubroutineType(types: !13)
!13 = !{!14}
!14 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!15 = !DILocation(line: 6, column: 3, scope: !11)
!16 = !DILocation(line: 7, column: 3, scope: !11)
