...
for.end:                                          ; preds = %for.cond
  ...
  br i1 %cmp3, label %land.lhs.true, label %lor.rhs, !dbg !40

land.lhs.true:                                    ; preds = %for.end
  %6 = load i32, i32* %y, align 4, !dbg !41
  %cmp4 = icmp eq i32 %6, 1000, !dbg !42
  br i1 %cmp4, label %lor.end, label %lor.rhs, !dbg !43

lor.rhs:                                          ; preds = %land.lhs.true, %for.end
  %7 = load i32, i32* %x, align 4, !dbg !44
  %cmp5 = icmp eq i32 %7, 0, !dbg !45
  br i1 %cmp5, label %land.rhs, label %land.end, !dbg !46

land.rhs:                                         ; preds = %lor.rhs
  %8 = load i32, i32* %z, align 4, !dbg !47
  %cmp6 = icmp eq i32 %8, 1000, !dbg !48
  br label %land.end

land.end:                                         ; preds = %land.rhs, %lor.rhs
  %9 = phi i1 [ false, %lor.rhs ], [ %cmp6, %land.rhs ], !dbg !49
  br label %lor.end, !dbg !43

lor.end:                                          ; preds = %land.end, %land.lhs.true
  %10 = phi i1 [ true, %land.lhs.true ], [ %9, %land.end ]
  %lor.ext = zext i1 %10 to i32, !dbg !43
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %lor.ext), !dbg !50
...
!1 = !DIFile(filename: "for-loop/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
