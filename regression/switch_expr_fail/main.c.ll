...
entry:
  ...
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 0), !dbg !10
  ret i32 0, !dbg !11
}
...
!1 = !DIFile(filename: "switch_expr_fail/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
...
!10 = !DILocation(line: 8, column: 13, scope: !6)
!11 = !DILocation(line: 11, column: 2, scope: !6)
