; ModuleID = 'switch_expr_fail/main.c'
source_filename = "switch_expr_fail/main.c"
...
entry:
  ...
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 0), !dbg !11
  ret i32 0, !dbg !12
}
...
!1 = !DIFile(filename: "switch_expr_fail/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
...
!11 = !DILocation(line: 8, column: 13, scope: !7)
!12 = !DILocation(line: 11, column: 2, scope: !7)
