...
for.cond41:                                       ; preds = %for.inc59, %for.end39
  ...
  br i1 %cmp42, label %for.body43, label %for.end61, !dbg !124
...
for.cond45:                                       ; preds = %for.inc56, %for.body43
  ...
  br i1 %cmp46, label %for.body47, label %for.end58, !dbg !135

for.body47:                                       ; preds = %for.cond45
  %25 = load i32, i32* %i40, align 4, !dbg !137
  %idxprom48 = sext i32 %25 to i64, !dbg !139
  %arrayidx49 = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %arr1, i64 0, i64 %idxprom48, !dbg !139
  ...
  %mul = mul nsw i32 2, %27, !dbg !141
  %28 = load i32, i32* %i40, align 4, !dbg !142
  %idxprom52 = sext i32 %28 to i64, !dbg !143
  %arrayidx53 = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %arr3, i64 0, i64 %idxprom52, !dbg !143
  %29 = load i32, i32* %j44, align 4, !dbg !144
  %idxprom54 = sext i32 %29 to i64, !dbg !143
  %arrayidx55 = getelementptr inbounds [3 x i32], [3 x i32]* %arrayidx53, i64 0, i64 %idxprom54, !dbg !143
  store i32 %mul, i32* %arrayidx55, align 4, !dbg !145
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %mul), !dbg !146
  br label %for.inc56, !dbg !147

for.inc56:                                        ; preds = %for.body47
  %30 = load i32, i32* %j44, align 4, !dbg !148
  %inc57 = add nsw i32 %30, 1, !dbg !148
  store i32 %inc57, i32* %j44, align 4, !dbg !148
...
for.inc59:                                        ; preds = %for.end58
  %31 = load i32, i32* %i40, align 4, !dbg !155
  %inc60 = add nsw i32 %31, 1, !dbg !155
  store i32 %inc60, i32* %i40, align 4, !dbg !155
...
!1 = !DIFile(filename: "2d_array_addition/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
...
!137 = !DILocation(line: 36, column: 31, scope: !138)
!138 = distinct !DILexicalBlock(scope: !133, file: !1, line: 35, column: 3)
!139 = !DILocation(line: 36, column: 26, scope: !138)
!140 = !DILocation(line: 36, column: 34, scope: !138)
!141 = !DILocation(line: 36, column: 25, scope: !138)
!142 = !DILocation(line: 36, column: 16, scope: !138)
!143 = !DILocation(line: 36, column: 11, scope: !138)
!144 = !DILocation(line: 36, column: 19, scope: !138)
