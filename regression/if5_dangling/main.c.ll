...
if.end3:                                          ; preds = %if.end, %entry
  %2 = load i32, i32* %fail, align 4, !dbg !27
  %cmp4 = icmp eq i32 %2, 1, !dbg !28
  %conv = zext i1 %cmp4 to i32, !dbg !28
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %conv), !dbg !29
  ret i32 0, !dbg !30
}
...
!1 = !DIFile(filename: "if5_dangling/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
...
!26 = !DILocation(line: 7, column: 20, scope: !20)
!27 = !DILocation(line: 13, column: 9, scope: !7)
!28 = !DILocation(line: 13, column: 13, scope: !7)
!29 = !DILocation(line: 13, column: 2, scope: !7)
!30 = !DILocation(line: 14, column: 4, scope: !7)
