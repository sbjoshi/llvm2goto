...
while.end:                                        ; preds = %if.then12, %while.cond
  ...
  %22 = load i32, i32* %cmp119, align 4, !dbg !86
  %tobool = icmp ne i32 %22, 0, !dbg !86
  br i1 %tobool, label %land.rhs, label %land.end, !dbg !87

land.rhs:                                         ; preds = %while.end
  %23 = load i32, i32* %found, align 4, !dbg !88
  %cmp22 = icmp eq i32 %23, 0, !dbg !89
  br label %land.end

land.end:                                         ; preds = %land.rhs, %while.end
  %24 = phi i1 [ false, %while.end ], [ %cmp22, %land.rhs ], !dbg !90
  %land.ext = zext i1 %24 to i32, !dbg !87
  store i32 %land.ext, i32* %cmp119, align 4, !dbg !91
  call void @llvm.dbg.declare(metadata i32* %cmp224, metadata !92, metadata !DIExpression()), !dbg !93
  %25 = load i32, i32* %first, align 4, !dbg !94
  %26 = load i32, i32* %last, align 4, !dbg !95
  %cmp25 = icmp sle i32 %25, %26, !dbg !96
  %conv26 = zext i1 %cmp25 to i32, !dbg !96
  store i32 %conv26, i32* %cmp224, align 4, !dbg !93
  %27 = load i32, i32* %cmp224, align 4, !dbg !97
  %tobool27 = icmp ne i32 %27, 0, !dbg !97
  br i1 %tobool27, label %land.rhs28, label %land.end31, !dbg !98

land.rhs28:                                       ; preds = %land.end
  %28 = load i32, i32* %found, align 4, !dbg !99
  %cmp29 = icmp sgt i32 %28, 0, !dbg !100
  br label %land.end31

land.end31:                                       ; preds = %land.rhs28, %land.end
  %29 = phi i1 [ false, %land.end ], [ %cmp29, %land.rhs28 ], !dbg !90
  %land.ext32 = zext i1 %29 to i32, !dbg !98
  store i32 %land.ext32, i32* %cmp224, align 4, !dbg !101
  %30 = load i32, i32* %cmp119, align 4, !dbg !102
  %call33 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %30), !dbg !103
  %31 = load i32, i32* %cmp224, align 4, !dbg !104
  %call34 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %31), !dbg !105
  %call35 = call i32 (...) @fun(), !dbg !106
  ret i32 0, !dbg !107
}
...
!1 = !DIFile(filename: "main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression/akash_test")
!2 = !{}
...
!86 = !DILocation(line: 34, column: 12, scope: !7)
!87 = !DILocation(line: 34, column: 17, scope: !7)
!88 = !DILocation(line: 34, column: 20, scope: !7)
!89 = !DILocation(line: 34, column: 25, scope: !7)
!90 = !DILocation(line: 0, scope: !7)
!91 = !DILocation(line: 34, column: 10, scope: !7)
!92 = !DILocalVariable(name: "cmp2", scope: !7, file: !1, line: 35, type: !10)
!93 = !DILocation(line: 35, column: 9, scope: !7)
!94 = !DILocation(line: 35, column: 17, scope: !7)
!95 = !DILocation(line: 35, column: 24, scope: !7)
!96 = !DILocation(line: 35, column: 22, scope: !7)
!97 = !DILocation(line: 36, column: 12, scope: !7)
!98 = !DILocation(line: 36, column: 17, scope: !7)
!99 = !DILocation(line: 36, column: 20, scope: !7)
!100 = !DILocation(line: 36, column: 25, scope: !7)
!101 = !DILocation(line: 36, column: 10, scope: !7)
!102 = !DILocation(line: 38, column: 12, scope: !7)
!103 = !DILocation(line: 38, column: 5, scope: !7)
!104 = !DILocation(line: 39, column: 12, scope: !7)
!105 = !DILocation(line: 39, column: 5, scope: !7)
!106 = !DILocation(line: 40, column: 5, scope: !7)
!107 = !DILocation(line: 42, column: 4, scope: !7)
