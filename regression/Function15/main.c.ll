; ModuleID = 'Function15/main.c'
source_filename = "Function15/main.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @f(i32 %a) #0 !dbg !7 {
entry:
...
entry:
  ...
  %call = call i32 @f(i32 -10), !dbg !19
  %call1 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %call), !dbg !20
  ret i32 0, !dbg !21
}
...
!1 = !DIFile(filename: "Function15/main.c", directory: "/home/akash/Documents/CBMC/cbmc/src/llvm2goto/regression")
!2 = !{}
