...
entry:
  ...
  call void @llvm.dbg.declare(metadata i32* %signed_int, metadata !24, metadata !25), !dbg !26
  store i32 1, i32* %signed_int, align 4, !dbg !26
  call void @llvm.dbg.declare(metadata float* %a_float, metadata !27, metadata !25), !dbg !28
  store float 1.000000e+00, float* %a_float, align 4, !dbg !28
  call void @llvm.dbg.declare(metadata double* %a_double, metadata !29, metadata !25), !dbg !31
  store double 1.000000e+00, double* %a_double, align 8, !dbg !31
  call void @llvm.dbg.declare(metadata i64* %long_long_int, metadata !32, metadata !25), !dbg !33
...
!1 = !DIFile(filename: "Pointer_byte_extract6/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
!3 = !{!4, !6, !8, !16, !17, !19}
...
!10 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 2, type: !11, isLocal: false, isDefinition: true, scopeLine: 3, isOptimized: false, unit: !0, variables: !2)
...
!24 = !DILocalVariable(name: "signed_int", scope: !10, file: !1, line: 4, type: !13)
!25 = !DIExpression()
