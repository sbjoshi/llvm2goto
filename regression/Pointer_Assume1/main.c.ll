; ModuleID = 'Pointer_Assume1/main.c'
source_filename = "Pointer_Assume1/main.c"
...
entry:
  ...
  %0 = load i32*, i32** %a, align 8, !dbg !16
  %cmp = icmp eq i32* %0, %b, !dbg !17
  %conv = zext i1 %cmp to i32, !dbg !17
  %call = call i32 (i32, ...) bitcast (i32 (...)* @assume to i32 (i32, ...)*)(i32 %conv), !dbg !18
  %1 = load i32*, i32** %a, align 8, !dbg !19
  %2 = load i32, i32* %1, align 4, !dbg !20
  %cmp1 = icmp eq i32 %2, 1, !dbg !21
  %conv2 = zext i1 %cmp1 to i32, !dbg !21
  %call3 = call i32 (i32, ...) bitcast (i32 (...)* @assert to i32 (i32, ...)*)(i32 %conv2), !dbg !22
  ret i32 0, !dbg !23
}
...
!1 = !DIFile(filename: "Pointer_Assume1/main.c", directory: "/home/rasika/llvm2goto/llvm2goto-regression-master")
!2 = !{}
...
!12 = !DIExpression()
!13 = !DILocation(line: 3, column: 9, scope: !6)
!14 = !DILocalVariable(name: "b", scope: !6, file: !1, line: 4, type: !9)
!15 = !DILocation(line: 4, column: 7, scope: !6)
!16 = !DILocation(line: 6, column: 10, scope: !6)
!17 = !DILocation(line: 6, column: 12, scope: !6)
!18 = !DILocation(line: 6, column: 3, scope: !6)
!19 = !DILocation(line: 7, column: 11, scope: !6)
!20 = !DILocation(line: 7, column: 10, scope: !6)
!21 = !DILocation(line: 7, column: 12, scope: !6)
!22 = !DILocation(line: 7, column: 3, scope: !6)
