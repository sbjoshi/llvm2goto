; ModuleID = 'arithmetic/div.c'
source_filename = "arithmetic/div.c"
...
entry:
  ...
  %div = sdiv i32 %0, %1, !dbg !21
  store i32 %div, i32* %k, align 4, !dbg !22
  ...
  store i32 0, i32* %k, align 4, !dbg !25
...
!1 = !DIFile(filename: "arithmetic/div.c", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
