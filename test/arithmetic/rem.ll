; ModuleID = 'arithmetic/rem.c'
source_filename = "arithmetic/rem.c"
...
entry:
  ...
  store i32 %rem, i32* %k, align 4, !dbg !22
...
!1 = !DIFile(filename: "arithmetic/rem.c", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
