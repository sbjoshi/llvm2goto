; ModuleID = 'arithmetic/mul.c'
source_filename = "arithmetic/mul.c"
...
entry:
  ...
  store i32 %mul, i32* %k, align 4, !dbg !22
  ...
  store i32 2, i32* %k, align 4, !dbg !25
...
!1 = !DIFile(filename: "arithmetic/mul.c", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
