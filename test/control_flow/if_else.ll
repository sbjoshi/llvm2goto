; ModuleID = 'control_flow/if_else.c'
source_filename = "control_flow/if_else.c"
...
if.end:                                           ; preds = %if.else, %if.then
  store i32 23, i32* %j, align 4, !dbg !28
  ret i32 0, !dbg !29
}
...
!1 = !DIFile(filename: "control_flow/if_else.c", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
...
!25 = distinct !DILexicalBlock(scope: !16, file: !1, line: 5, column: 9)
!26 = !DILocation(line: 6, column: 9, scope: !25)
!27 = !DILocation(line: 6, column: 5, scope: !25)
!28 = !DILocation(line: 8, column: 4, scope: !6)
!29 = !DILocation(line: 9, column: 2, scope: !6)
