; ModuleID = 'control_flow/if.c'
source_filename = "control_flow/if.c"
...
if.end:                                           ; preds = %if.then, %entry
  store i32 23, i32* %j, align 4, !dbg !24
  ret i32 0, !dbg !25
}
...
!1 = !DIFile(filename: "control_flow/if.c", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
...
!24 = !DILocation(line: 6, column: 4, scope: !6)
!25 = !DILocation(line: 7, column: 2, scope: !6)
