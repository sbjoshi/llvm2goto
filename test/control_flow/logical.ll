; ModuleID = 'logical.cpp'
source_filename = "logical.cpp"
...
entry:
  ...
  store i32 2, i32* %j, align 4, !dbg !18
  store i32 4, i32* %k, align 4, !dbg !19
...
!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !1, producer: "clang version 5.0.0 (trunk 295264)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !2)
!1 = !DIFile(filename: "logical.cpp", directory: "/home/rasika/Downloads/llvm_clang/build/bin")
!2 = !{}
...
!16 = !DILocation(line: 2, column: 10, scope: !6)
!17 = !DILocation(line: 3, column: 4, scope: !6)
!18 = !DILocation(line: 4, column: 4, scope: !6)
!19 = !DILocation(line: 5, column: 4, scope: !6)
!20 = !DILocation(line: 6, column: 2, scope: !6)
